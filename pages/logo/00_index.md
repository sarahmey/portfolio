...
Hieronder is nog wat informatie te vinden over het logo, technische specificaties zijn te vinden bij <a href="{{'/logo/1_variaties.html' | relative_url }}"> variaties</a>. Bij <a href="{{'/logo/2_gebruik.md' | relative_url }}"> gebruik</a> is te vinden welke variatie van het logo u in specifieke gevallen. 
